...
import { useInfiniteDiscoverPrompts } from "@/hooks/usePrompts";
...
export function DiscoverContent() {
  ...
  const {
    data,
    isLoading: promptsInitialLoading,
    error,
    fetchNextPage,
    hasNextPage,
    isFetchingNextPage,
  } = useInfiniteDiscoverPrompts(
    24,
    categoryId || null,
    modelId || null,
    tag || null
  ...
  const showHeader = promptsInitialLoading || prompts.length === 0;
