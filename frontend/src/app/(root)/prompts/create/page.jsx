...
export default function CreatePromptPage() {
  ...
  const onSubmit = async (data) => {
    try {
      ...
      const result = await createPromptMutation.mutateAsync(submitData);
        ...
        <CardContent>
          {createPromptMutation.error && (
            <div className="mb-4 rounded-md bg-red-500/10 border border-red-500/20 p-3 text-sm text-red-400">
              {createPromptMutation.error?.response?.data?.message || 
          ...
          <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
            ...
            <div className="pt-4 flex justify-end gap-4">
              ...
              <Button
                ...
                disabled={createPromptMutation.isPending || uploadImageMutation.isPending || !uploadedImageUrl}
              >
                {createPromptMutation.isPending ? "Creating..." : uploadImageMutation.isPending ? "Uploading..." : "Create"}
              </Button>
            </div>
          </form>
        </CardContent>
